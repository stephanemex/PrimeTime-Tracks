...
document.addEventListener("DOMContentLoaded", function () {
    console.log("Initialisation du gestionnaire de fichiers FCPXML");
    ...
    if (typeof JSZip === "undefined") {
        console.error("JSZip n'est pas chargé. Assurez-vous d'avoir inclus la bibliothèque JSZip.");
        showMessage("Erreur : JSZip n'est pas chargé.", "error");
        return;
    }
